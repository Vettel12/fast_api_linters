...
@router.get(
    "/", response_model=List[schemas.RecipeShort], summary="Список всех рецептов"
)
async def read_recipes(db: SessionDep) -> Any:
    """
...
async def read_recipe(recipe_id: int, db: SessionDep) -> Any:
    """
...
async def create_new_recipe(recipe: schemas.RecipeCreate, db: SessionDep) -> Any:
    """
